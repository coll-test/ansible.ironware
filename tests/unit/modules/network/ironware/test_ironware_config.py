...
from ansible_collections.ansible.ironware.tests.unit.compat.mock import patch
from ansible_collections.ansible.ironware.tests.unit.modules.utils import set_module_args
from ansible_collections.ansible.ironware.plugins.modules import ironware_config
...
class TestIronwareConfigModule(TestIronwareModule):
    ...
    def setUp(self):
        ...
        self.mock_get_config = patch('ansible_collections.ansible.ironware.plugins.modules.ironware_config.get_config')
        self.get_config = self.mock_get_config.start()

        self.mock_load_config = patch('ansible_collections.ansible.ironware.plugins.modules.ironware_config.load_config')
        self.load_config = self.mock_load_config.start()

        self.mock_run_commands = patch('ansible_collections.ansible.ironware.plugins.modules.ironware_config.run_commands')
