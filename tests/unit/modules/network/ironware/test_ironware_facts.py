...
from ansible_collections.ansible.ironware.plugins.modules import ironware_facts
...
class TestIronwareFacts(TestIronwareModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch(
            'ansible_collections.ansible.ironware.plugins.modules.ironware_facts.run_commands')
