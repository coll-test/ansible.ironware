...
from ansible_collections.ansible.ironware.plugins.modules import ironware_command
...
class TestIronwareCommandModule(TestIronwareModule):
    ...
    def setUp(self):
        ...
        self.mock_run_commands = patch('ansible_collections.ansible.ironware.plugins.modules.ironware_command.run_commands')
